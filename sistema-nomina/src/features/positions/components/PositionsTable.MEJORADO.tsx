...
export default function PositionsTable({ rows }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {conflictError && (
        <div className="animate-slide-down rounded-2xl border-2 border-amber-300 bg-gradient-to-r from-amber-50 to-amber-100 p-5 shadow-xl ring-4 ring-amber-200/50">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-bold text-amber-900">⚠️ Error de Integridad Referencial</h3>
              <p className="mt-2 text-sm leading-relaxed text-amber-800">
                {conflictError.message}
              </p>
              <p className="mt-3 text-xs font-medium text-amber-700">
                💡 <strong>Solución:</strong> Primero reasigna o desactiva todos los empleados que tienen este puesto, luego podrás desactivarlo.
              </p>
            </div>
            <button
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-3 font-medium">
                    {p.nombre}
                    {hasError && (
                      <span className="ml-2 inline-flex items-center gap-1 rounded-full bg-amber-600 px-2 py-0.5 text-xs font-semibold text-white">
                  ...
                  <td className="px-4 py-3 font-semibold text-emerald-700">{fmtCurrency(p.salarioBase)}</td>
